...
public class Deployments {
    ...
    private static final String ARCHIVE_NAME = System.getProperty("prova-jdg.war.file");
    private static final String BUILD_DIRECTORY = System.getProperty("prova-jdg.war.directory");
